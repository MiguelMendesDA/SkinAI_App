...
# Use connection variables to connect to the database
conn = mysql.connector.connect(
    host='localhost',
    database='skin_cancer_app',
    user='root',
    password='Lw05pr12.:,;12'
)
...
#app.config['MAIL_USERNAME'] = 'miguelmendesdataanalyst@gmail.com'
#app.config['MAIL_PASSWORD'] = 'Lw05pr12.:,;12'
#app.config['MAIL_DEFAULT_SENDER'] = ('Skin Cancer App', 'miguelmendesdataanalyst@gmail.com')
